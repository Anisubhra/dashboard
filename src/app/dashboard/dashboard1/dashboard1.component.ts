...
@Component({
  ...
  providers: [AuthService, SummaryService]
})

export class Dashboard1Component {
  constructor(private authService: AuthService, private summaryService: SummaryService, private router: Router) {
    // const role = this.authService.loggedInUser.role;

    // if (role == 'member') {
    //   this.summaryService.trackAnalytics(this.router.url);
    // }
  }
