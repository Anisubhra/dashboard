...
export const ROUTES: RouteInfo[] = [
  {
    path: '/dashboard/dashboard1', title: 'Home', icon: 'ft-home', class: '', badge: '', badgeClass: 'b', isExternalLink: false, submenu: []
  },
  {
    path: '/tables/tables', title: 'Summary', icon: 'ft-bar-chart-2', class: '', badge: '', badgeClass: '', isExternalLink: false,
    submenu: []
  },
  // {
